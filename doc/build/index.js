 ...
 * @module kscroll
 **/
KISSY.add('kg/nbSelect/2.0.0/plugin/kscroll',function (S, Node,Base) {
    var $ = Node.all,
 ...
 * @module nbSelect
 **/
KISSY.add('kg/nbSelect/2.0.0/index',function(S, XTemplate, DOM, Kscroll){
